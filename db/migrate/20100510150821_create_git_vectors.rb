class CreateGitVectors < ActiveRecord::Migration
  def self.up
    ...
    add_index :git_vectors, [:sid, :chain_code],   :unique => true
    add_index :git_vectors, [:sunid, :chain_code], :unique => true
  end

  def self.down
    drop_table :git_vectors
  end
end
